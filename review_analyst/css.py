...
[data-testid="stFileUploaderDropzone"]:hover{border-color:rgba(79,70,229,.32)!important;background:#f8faff!important;}
...
[data-testid="stRadio"] label:hover{border-color:rgba(79,70,229,.26);}
